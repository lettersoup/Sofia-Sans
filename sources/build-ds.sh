...
fontmake -g SofiaSans-VF-New.glyphs -o variable --output-path $VF_FILE
# glyphs2ufo SofiaSans-VF-New-Prueba2a.glyphs --generate-GDEF
# fontmake -m SofiaSans-vf2.designspace -o variable --output-path $VF_FILE
